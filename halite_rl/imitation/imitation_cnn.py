...
class ImitationCNN(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self._conv4 = nn.Conv2d(32, num_classes, 1)
...
#         super().__init__()
#         # Note: padding is set to maintain HxW dimensions throughout.
#         self._conv1 = nn.Conv2d(9, 16, 21, padding=10, padding_mode="circular")
#         self._conv2 = nn.Conv2d(16, 32, 21, padding=10, padding_mode="circular")
#         self._conv3 = nn.Conv2d(32, 64, 21, padding=10, padding_mode="circular")
#         self._conv4 = nn.Conv2d(64, 64, 21, padding=10, padding_mode="circular")
#         self._conv5 = nn.Conv2d(64, 8, 1)
